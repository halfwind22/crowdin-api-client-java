...
public class SourceFilesApi extends CrowdinApi {
     ...
     * </ul>
     */
    public ResponseList<Branch> listBranches(Long projectId, String name, Integer limit, Integer offset, Map<String,SortOrder> orderByMap) throws HttpException, HttpBadRequestException {
        Map<String, Optional<Object>> queryParams = HttpRequestConfig.buildUrlParams(
                "name", Optional.ofNullable(name),
                "limit", Optional.ofNullable(limit),
                "offset", Optional.ofNullable(offset),
     ...
     * </ul>
     */
    public ResponseList<Directory> listDirectories(Long projectId, Long branchId, Long directoryId, String filter, Object recursion, Integer limit, Integer offset,Map<String,SortOrder> orderByMap) throws HttpException, HttpBadRequestException {
        Map<String, Optional<Object>> queryParams = HttpRequestConfig.buildUrlParams(
                "branchId", Optional.ofNullable(branchId),
                "directoryId", Optional.ofNullable(directoryId),
                "filter", Optional.ofNullable(filter),
     ...
     * </ul>
     */
    public ResponseList<? extends FileInfo> listFiles(Long projectId, Long branchId, Long directoryId, String filter, Object recursion, Integer limit, Integer offset,Map<String,SortOrder> orderByMap) throws HttpException, HttpBadRequestException {
        Map<String, Optional<Object>> queryParams = HttpRequestConfig.buildUrlParams(
                "branchId", Optional.ofNullable(branchId),
                "directoryId", Optional.ofNullable(directoryId),
                "filter", Optional.ofNullable(filter),
